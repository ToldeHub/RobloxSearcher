...
//dont worry, i know youre looking through the code for malware beacuse of searchblox incident, its okay, "token" is just trying to get the userid for the thumbnails on join
const getServerFromThumbnail = async (thumbnail, userId, placeId) => {
    return new Promise(async (resolve, reject) => {
        let message = ""
        const token = await getUserToken(userId); // right here it states it
        if (!!token) {
...
console.log("RobloxSearch has loaded - Tolde was here")
